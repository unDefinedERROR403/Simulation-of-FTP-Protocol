...
int main(int argc, char const *argv[]) {
	...
	while(1) {
		...
		if((strcmp(buffer,"RETR\n")==0) || (strcmp(buffer,"RETR\n")==0)){
			printf("Not Imoplemented\n");
		}
		
		if((strcmp(buffer,"stor\n")==0) || (strcmp(buffer,"STOR\n")==0)){
			printf("Not Imoplemented\n");
		}
		
		if((strcmp(message[0],"RETR\n")==0) || (strcmp(message[0],"RETR\n")==0)){
			printf("Not Imoplemented\n");
		}
		
		if((strcmp(message[0],"stor\n")==0) || (strcmp(message[0],"STOR\n")==0)){
			printf("Not Imoplemented\n");
		}
